...
describe('VertexSquare', () => {
  ...
  it('instance contain protrude relation with Edge', () => {
    ...
    expect(vertex.protrude(DIRECTION.N)).toEqual<CubeCoordinates | undefined>(
      results.get(DIRECTION.N)
    )
    expect(vertex.protrude(DIRECTION.E)).toEqual<CubeCoordinates | undefined>(
      results.get(DIRECTION.E)
    )
    expect(vertex.protrude(DIRECTION.S)).toEqual<CubeCoordinates | undefined>(
      results.get(DIRECTION.S)
    )
    expect(vertex.protrude(DIRECTION.W)).toEqual<CubeCoordinates | undefined>(
